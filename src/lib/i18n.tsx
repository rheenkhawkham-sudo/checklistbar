...
const dict = {
  en: {
    ...
    outletNamesSaved: "Outlets updated",
    manageOutlets: "Manage outlets",
    newOutletName: "New outlet name",
    addOutlet: "Add outlet",
    outletMinOne: "At least one outlet is required",
    deleteOutletConfirm: "Delete outlet \"{name}\"?",
    deleteAllHistory: "Delete all history",
    deleteAllHistoryConfirm: "Delete ALL report history permanently?",
  ...
  th: {
    ...
    maxTasks: "เพิ่มงานได้สูงสุด 50 งานต่อหัวข้อ",
    noTasks: "ยังไม่มีงาน",
    ...
    deleteSelected: "ลบที่เลือก ({n})",
    deleteGroup: "ลบกลุ่มนี้",
    deleteAll: "ลบทั้งหมด",
