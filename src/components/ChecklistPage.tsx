  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const { error: dbErr } = await supabase.from("checklist_reports").insert({
        ...
        open_tasks: openTasks as unknown as Record<string, unknown>[],
        close_tasks: closeTasks as unknown as Record<string, unknown>[],
        monthly_tasks: monthlyTasks as unknown as Record<string, unknown>[],
